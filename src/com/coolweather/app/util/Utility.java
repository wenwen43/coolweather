...
/*书p497
 * 提供了handleProvincesResponse()、handleCitiesResponse()、handleCountiesResponse()这三个方法，
...
public class Utility {
	...
	* 因为天气信息是以JSON格式返回的，因此使用JSONObject将数据解析出来
	* 再采用saveWeatherInfo()方法将天气信息全部存储到SharedPreference文件中，这其中还存储了一个city_selected标志位，辨别是否已选中一个城市
	*/
